...
public:
  Grouping()
  : show_keypoints_ (false), show_correspondences_ (false), use_cloud_resolution_ (false),
    use_hough_ (true), model_ss_ (0.01f), scene_ss_ (0.03f), rf_rad_ (0.015f),
    descr_rad_ (0.02f), cg_size_ (0.01f), cg_thresh_ (5.0f), updateCloud(false);
  {
    cloud_sub_ = nh_.subscribe("/ensenso/cloud", 1, 
          &Grouping::cloudCallback, this);
  }
...
parseCommandLine (int argc, char *argv[])
{
  ...
  scene_filename_ = "super_scene.pcd";
